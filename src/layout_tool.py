...
class LayoutTool:
    ...
    def export_islm(self, global_filename: str = "global.dxf", unit_filename: str = "unit_design.dxf"):
        ...
        doc_global.header['$INSUNITS'] = global_unit_code
        ...
        doc_unit.header['$INSUNITS'] = unit_design_unit_code
        ...
        print(f"Exported iSLM Unit DXF ({self.unit_design_unit}): {unit_filename}")
    ...
    def export_vtu(self, filename: str, layers: Optional[List[str]] = None):
        ...
        mesh.write(filename)
        print(f"Exported VTU ({self.global_unit}): {filename}")
