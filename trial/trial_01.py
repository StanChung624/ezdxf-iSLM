...
def main() -> None:
    out_dir = Path(__file__).resolve().parent / "trial_01_output"
    ...
    # One die design: 5x5 rectangle centered at local origin.
    ...
    result = export_islm_with_ini(
        layout=layout,
        workdir=str(out_dir),
        project_name="trial_01_runtime",
        anchor_point=(0.0, 0.0, 0.0),
        runner_mdg_path=str(out_dir / "runner_100.mdg"),
        chip_z=0.0,
        chip_thickness=0.3,
        compound_z=0.0,
